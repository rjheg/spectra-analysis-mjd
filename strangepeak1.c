...
//  
//
//  Created by Ryan Hegedus on 6/7/18.
//
...
void strangepeak1() {
    ...
    double startTime_s = 0.0, stopTime_s = 0.0;
    
    
    int lowbin=6840.0, highbin = 6870.0;
    int numbins=3000/10;
    int line = 1;
...
//    tree0->Add("/Users/rjheg/Desktop/skimfiles_DS1/skim*.root");
    ...
    tree0->SetBranchAddress("startTime_s", &startTime_s);
    tree0->SetBranchAddress("stopTime_s", &stopTime_s);
